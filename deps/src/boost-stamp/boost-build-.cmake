...
set(stdout_log "/home/xiaobo/myspace/owner/mynetwork/guodong/deps/src/boost-stamp/boost-build-out.log")
set(stderr_log "/home/xiaobo/myspace/owner/mynetwork/guodong/deps/src/boost-stamp/boost-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/xiaobo/myspace/owner/mynetwork/guodong/deps/src/boost-stamp/boost-build-*.log")
  endif()
  ...
  set(msg "boost build command succeeded.  See also /home/xiaobo/myspace/owner/mynetwork/guodong/deps/src/boost-stamp/boost-build-*.log")
  message(STATUS "${msg}")
endif()
